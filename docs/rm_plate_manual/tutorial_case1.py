"""OpenSG-RM Tutorial 1 -- cross-ply [0/90/0] plate, S = a/h = 10.

Standalone: run it from anywhere inside the repository and it produces
    tutorial_case1_sg.yaml / _sg.png      the 1-D SG and its mesh figure
    tutorial_case1_outofplane.png         sigma_13, sigma_33 profiles
    tutorial_case1_inplane.png            sigma_11, sigma_22, sigma_12
    tutorial_case1_disp.png               U1, U2, U3
...
Graphite/epoxy 25:1 plies, three equal thicknesses, [0/90/0] bottom-up,
...
yml = os.path.join(HERE, "tutorial_case1_sg.yaml")
...
for fname, specs in (
    ...
    fig.tight_layout()
    fig.savefig(os.path.join(HERE, "tutorial_case1_%s.png" % fname), dpi=150,
                bbox_inches="tight")
    plt.close(fig)
print("\nwrote tutorial_case1_{sg,outofplane,inplane,disp}.png")
