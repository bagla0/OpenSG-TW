...
table in the User Manual freezes the anchors).  The failure indices printed
by every script use \emph{example} allowables --- replace the
\code{Xt/Xc/Yt/Yc/S12a/S13a/S23a} block with your material system before
drawing conclusions.
\end{document}
