"""OpenSG-RM Tutorial 4 -- symmetric angle-ply [30/-30/-30/30] plate, L/h = 4.

Standalone: run it from anywhere inside the repository and it produces
    tutorial_case4_sg.yaml / _sg.png      the 1-D SG and its mesh figure
    tutorial_case4_outofplane.png         sigma_13, sigma_23, sigma_33
    tutorial_case4_inplane.png            sigma_11, sigma_22, sigma_12
    tutorial_case4_disp.png               U1, U2, U3
...
bottom, q0 = 1 psi.  Four equal plies [30/-30/-30/30] bottom-up (25:1
...
layup = {"mat_names": ["yu"] * 4,
         "thick":     [0.25] * 4,
         "angles":    [30.0, -30.0, -30.0, 30.0]}    # bottom ply first

yml = os.path.join(HERE, "tutorial_case4_sg.yaml")
...
for fname, specs in (
    ...
    fig.tight_layout()
    fig.savefig(os.path.join(HERE, "tutorial_case4_%s.png" % fname), dpi=150,
                bbox_inches="tight")
    plt.close(fig)
print("\nwrote tutorial_case4_{sg,outofplane,inplane,disp}.png")
