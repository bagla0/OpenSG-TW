...
computed windIO cross-sections along the span and colours the outer surface by the recovered field,
interpolated between adjacent stations: the axial stress $\sigma_{11}$ (top) and the displacement
magnitude $|u|$ (bottom) both peak inboard and decay toward the slender tip---a full
three-dimensional strength picture of the blade assembled from six one-dimensional cross-sectional
solves, each a fraction of a second.

\begin{figure}[htbp]\centering
\includegraphics[width=0.82\textwidth]{figures/blade3d_sigma11.png}\\[2pt]
\includegraphics[width=0.82\textwidth]{figures/blade3d_umag.png}
\caption{Full IEA-22 blade lofted from the six computed windIO cross-sections and coloured by the
dehomogenized field on the outer mould line, interpolated between adjacent stations: axial stress
$\sigma_{11}$ (top) and displacement magnitude $|u|$ (bottom) under the spanwise-varying beam load,
each with a single colour bar spanning the whole blade.}\label{fig:blade3d}
\end{figure}
