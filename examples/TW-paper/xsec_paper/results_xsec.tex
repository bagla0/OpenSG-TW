...
coincide point-for-point. Rendered as an exaggerated three-dimensional surface
(Figure~\ref{fig:r020_iso}) the axial warping $u_1$ on the distorted mesh is indistinguishable
between the two recoveries.
...
\begin{figure}[htbp]\centering
\includegraphics[width=\textwidth]{figures/r020_iso_warp.png}
\caption{Axial warping $u_1$ on the distorted section (isometric, exaggerated $\times1558$):
VABS solid (left) vs.\ OpenSG RM shell dehomogenization (right). The recovered warped surface is
reproduced by the $1$-D RM solve.}\label{fig:r020_iso}
\end{figure}
