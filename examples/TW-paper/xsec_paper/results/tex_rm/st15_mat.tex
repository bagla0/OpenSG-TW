...
\caption{Constituent material properties of the IEA/BAR-URC station-15 laminates ($E$, $G$ in GPa; $\rho$ in kg/m$^3$).}\label{tab:st15_mat}
\setlength{\tabcolsep}{5pt}\resizebox{\textwidth}{!}{%
\begin{tabular}{lcccccccccc}
\hline
Material & $E_1$ & $E_2$ & $E_3$ & $G_{12}$ & $G_{13}$ & $G_{23}$ & $\nu_{12}$ & $\nu_{13}$ & $\nu_{23}$ & $\rho$ \\
\hline
Glass uniax   & 43.7 & 16.5 & 15.4 & 3.265 & 3.495 & 3.48 & 0.262 & 0.264 & 0.35 & 1940 \\
Carbon uniax  & 158 & 9.1 & 9.1 & 4.131 & 4.131 & 2.689 & 0.313 & 0.313 & 0.471 & 1600 \\
