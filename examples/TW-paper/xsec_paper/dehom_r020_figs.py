...
make("solid.lp_sparcap_center_thickness_r020.coords",
     "through-thickness (mm, OML$\\to$IML)",
     "IEA r=0.2 LP spar-cap CENTRE through-thickness: RM shell vs VABS",
     os.path.join(FIG, "dehom_r020_capcentre.png"))
