...
all twelve non-zero terms is $5.6\%$ for both shell models. The RM model
improves the torsional stiffness ($GJ$ to $+2.2\%$ versus $-3.6\%$ for
Kirchhoff), consistent with its retention of transverse shear. The chordwise
...
$C_{44}$ (GJ)        & $1.595\!\times\!10^{8}$   & $1.504\!\times\!10^{8}$   & $1.560\!\times\!10^{8}$   & $+2.2\%/{-}3.6\%$\\
...
\item on a realistic wind-turbine blade station (multi-region laminate with
spar caps, shear webs and sandwich panels) the homogenized $6\times6$ matches a
VABS solid-element reference to a $5.6\%$ relative norm, and the recovered stress
in a thin sandwich panel agrees with VABS to within $1.4\%$.
\end{itemize}
