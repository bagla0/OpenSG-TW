...
macroscopic twist $\kappa_1$ with coefficient $-1$ for the RM model (the
remainder carried by the $\dot\omega_2$ fluctuation), in contrast to $-2$ for
the Kirchhoff model; using the Kirchhoff value in the RM model corrupts the
...
\kappa_{12}{+}\kappa_{21}&=-\kappa_1+\frac{\dot{\omega}_2}{\dot{x}_2}
...
$\kappa_{12}{+}\kappa_{21}$ is $-1$ (the remainder carried by $\dot\omega_2$),
in contrast to $-2$ for Kirchhoff.
